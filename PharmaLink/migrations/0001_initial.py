# Generated by Django 4.2.3 on 2023-10-12 11:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_issued', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PharmaLink.doctor')),
                ('patient_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='PharmaLink.patients')),
            ],
        ),
        migrations.CreateModel(
            name='PharmacyClerk',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='PharmaLink.adminhod')),
                ('patient_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PharmaLink.patients')),
                ('pharmacist_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='PharmaLink.pharmacist')),
            ],
        ),
        migrations.CreateModel(
            name='Inventory',
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='PharmaLink.category')),
            ],
        ),
        migrations.AddField(
            model_name='doctor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='PharmaLink.inventory')),
                ('patient_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='PharmaLink.patients')),
            ],
        ),
        migrations.AddField(
            model_name='adminhod',
